...
namespace SigesoftWebUI.Utils
{
    public static class ExtensionMethods
    {
        ...
        public static string ToFullFormattedStringDate2(this DateTime obj)
        {
            return obj.ToString("dd/MM/yyyy HH:mm:ss", CultureInfo.InvariantCulture);
        }
        ...
        public static string GetValue<TKey>(this Dictionary<TKey, string> dictionary, TKey key, string valueDefault = "")
        {
            return dictionary.ContainsKey(key) ? dictionary[key] : valueDefault;
        }

        public static int GetValue<TKey>(this Dictionary<TKey, int> dictionary, TKey key, int valueDefault = 0)
        {
            return dictionary.ContainsKey(key) ? dictionary[key] : valueDefault;
        }

        public static bool GetValue<TKey>(this Dictionary<TKey, bool> dictionary, TKey key, bool valueDefault = false)
        {
            return dictionary.ContainsKey(key) ? dictionary[key] : valueDefault;
        }
